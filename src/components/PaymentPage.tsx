...
const PaymentPage = ({ username }: { username: string }) => {
  ...
  const users = [
    { username: "usmanMazhar", id: 1, payment: 1000 },
    { username: "mansoorAhmed", id: 2, payment: 2000 },
    { username: "mohsinIshaq", id: 3, payment: 3000 },
    { username: "muhammadSultan", id: 4, payment: 4000 },
    { username: "syedIfraheem", id: 5, payment: 5000 },
  ];
